...
class ModelFactory():
    def __init__(self, model, models_dir, name=None):
        ...
        self.model_state_dict_path = os.path.join(self.model_dir, "model_state_dict.pt")
        self.optimizer_state_dict_path = os.path.join(self.model_dir, "optimizer_state_dict.pt")
        self.scheduler_state_dict_path = os.path.join(self.model_dir, "scheduler_state_dict.pt")
        self.loss_dict_path = os.path.join(self.model_dir, "loss_dict.pkl")
